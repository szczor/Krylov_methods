...
title_str1 = 'GMRES z i bez preconditioingu dla losowej macierzy rzadkiej';
title({title_str1}), hold off

saveas(gcf,'C:\Users\rysza\Desktop\PMPMPMPM\implementation\Plots\both\random_1010.jpg')