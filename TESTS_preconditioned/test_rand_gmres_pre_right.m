...
title_str1 = 'GMRES z prawym preconditioningiem dla macierzy losowej';
title({title_str1}), hold off
saveas(gcf,'C:\Users\rysza\Desktop\PMPMPMPM\implementation\Plots\preconditioned\right_preconditioned_random.jpg')